...
const config = {
  title: 'Introduction to Computer Systems (Section - O)',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/FahimFBA/ICS-O-Fall2024',
            label: 'GitHub',
            position: 'right',
          },
        ],
